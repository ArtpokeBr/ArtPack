...
# *======= Variables =======*
	...
	#var wyvernGroup = ArmorHandler.createArmorGroup("wyvern", 0.01);
...
# *======= Energy Armor =======*
	...
	energyGroup.addArmor(ArmorHandler.createArmorSlot("head", <thaumcraft:thaumium_helm>, 5, 0.05));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("chest", <thaumcraft:thaumium_chest>, 5, 0.05));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("legs", <thaumcraft:thaumium_legs>, 5, 0.05));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("feet", <thaumcraft:thaumium_boots>, 5, 0.05));
	...
	energyGroup.addArmor(ArmorHandler.createArmorSlot("head", <careerbees:bee.armor.head>, 1, 0.01));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("chest", <careerbees:bee.armor.chest>, 1, 0.01));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("legs", <careerbees:bee.armor.legs>, 1, 0.01));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("feet", <careerbees:bee.armor.feet>, 1, 0.01));
...
# *======= Skeleton Armor =======*
	...
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <thaumcraft:thaumium_helm>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <thaumcraft:thaumium_chest>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <thaumcraft:thaumium_legs>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <thaumcraft:thaumium_boots>, 5, 0.05));
	...
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <careerbees:bee.armor.head>, 1, 0.01));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <careerbees:bee.armor.chest>, 1, 0.01));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <careerbees:bee.armor.legs>, 1, 0.01));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <careerbees:bee.armor.feet>, 1, 0.01));
