...
mods.immersiveengineering.Blueprint.addRecipe("components", <immersiveengineering:material:26> * 2, [<contenttweaker:glasstube> * 2, <immersiveengineering:metal:34>, <immersiveengineering:material:21> * 2, <techreborn:dust:43>]);

//Tube Mold
mods.immersiveengineering.Blueprint.addRecipe("molds", <contenttweaker:tubemold>, [<immersiveengineering:tool:1>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>]);

//Cable Mold
mods.immersiveengineering.Blueprint.addRecipe("molds", <contenttweaker:cablemold>, [<immersiveengineering:tool:1>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>]);
...
recipes.addShaped(<contenttweaker:basiccircuitbase> * 1, [[<contenttweaker:constantanbolt>, <immersiveengineering:metal:38>, <contenttweaker:constantanbolt>], [<contenttweaker:constantanbolt>, <contenttweaker:densesteelplate>, <contenttweaker:constantanbolt>],[<contenttweaker:constantanbolt>, <immersiveengineering:metal:38>, <contenttweaker:constantanbolt>]]);
...
recipes.addShaped(<contenttweaker:refinedpiston> * 1, [[<immersiveengineering:metal:38>, <immersiveengineering:metal:38>, <immersiveengineering:metal:38>], [<techreborn:cable:5>, <immersiveengineering:material:2>, <immersiveengineering:material:2>],[<techreborn:cable:5>, <contenttweaker:electricmotor>, <thermalfoundation:material:288>]]);
