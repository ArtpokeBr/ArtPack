...
recipes.addShaped(<nuclearcraft:part:4> * 4, [[<ore:plateCopper>, <ore:plateCopper>, <ore:plateCopper>], [<ore:plateSilver>, <quantumflux:craftingpiece:6>, <ore:plateSilver>],[<ore:plateCopper>, <ore:plateCopper>, <ore:plateCopper>]]);
...
recipes.addShaped(<nuclearcraft:part:10> * 2, [[<techreborn:plates:31>, <techreborn:plates:33>, <techreborn:plates:31>], [<techreborn:plates:33>, <thermalexpansion:frame:0>, <techreborn:plates:33>],[<techreborn:plates:31>, <techreborn:plates:33>, <techreborn:plates:31>]]);
...
# Forestry Compat =====================================================
    ...
    mods.nuclearcraft.infuser.addRecipe([<teslacorelib:machine_case>, <liquid:seed.oil>*1000, <forestry:impregnated_casing>]);
     //Fluid Infuser impregnated Casing 2
    mods.nuclearcraft.infuser.addRecipe([<teslacorelib:machine_case>, <liquid:seed_oil>*1000, <forestry:impregnated_casing>]);
